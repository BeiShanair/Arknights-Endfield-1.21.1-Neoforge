...
import com.besson.endfield.screen.custom.production1.FittingUnitScreenHandler;
...
public class FittingUnitBlockEntity extends BaseIOBlockEntity<FittingUnitRecipe> implements GeoBlockEntity {
    ...
    public FittingUnitBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.FITTING_UNIT.get(), pos, state, 40);
    }
    ...
    @Override
    protected Optional<RecipeHolder<FittingUnitRecipe>> getMatchRecipe(Level world) {
