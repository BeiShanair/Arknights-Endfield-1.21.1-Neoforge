...
public class GrindingUnitScreen extends AbstractContainerScreen<GrindingUnitScreenHandler> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(ArknightsEndField.MOD_ID, "textures/gui/grinding_unit.png");
