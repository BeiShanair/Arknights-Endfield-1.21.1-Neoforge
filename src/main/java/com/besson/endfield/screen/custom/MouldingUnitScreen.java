...
public class MouldingUnitScreen extends AbstractContainerScreen<MouldingUnitScreenHandler> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(ArknightsEndField.MOD_ID, "textures/gui/moulding_unit.png");
