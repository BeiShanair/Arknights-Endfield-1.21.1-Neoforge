...
public class FittingUnitScreen extends AbstractContainerScreen<FittingUnitScreenHandler> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(ArknightsEndField.MOD_ID, "textures/gui/fitting_unit.png");
