...
public class RefiningUnitScreenHandler extends AbstractContainerMenu {
    ...
    public RefiningUnitScreenHandler(int syncId, Inventory playerInventory, BlockEntity blockEntity, ContainerData propertyDelegate) {
        super(ModScreens.REFINING_UNIT_SCREEN.get(), syncId);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, entity.getBlockPos()),
                pPlayer, ModBlocks.REFINING_UNIT.get());
    }
