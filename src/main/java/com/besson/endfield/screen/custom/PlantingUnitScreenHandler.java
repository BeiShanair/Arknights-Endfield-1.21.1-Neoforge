...
public class PlantingUnitScreenHandler extends AbstractContainerMenu {
    ...
    public PlantingUnitScreenHandler(int syncId, Inventory playerInventory, BlockEntity blockEntity, ContainerData propertyDelegate) {
        super(ModScreens.PLANTING_UNIT_SCREEN.get(), syncId);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, entity.getBlockPos()),
                pPlayer, ModBlocks.PLANTING_UNIT.get());
    }
