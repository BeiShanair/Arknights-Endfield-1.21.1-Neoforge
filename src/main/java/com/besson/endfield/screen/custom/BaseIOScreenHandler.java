...
public abstract class BaseIOScreenHandler<B extends BaseIOBlockEntity<?>> extends AbstractContainerMenu {
    protected final ContainerData propertyDelegate;
    
    public final B entity;
    protected final Level level;
    public BaseIOScreenHandler(@Nullable MenuType<?> type, int syncId, Inventory playerInventory, B blockEntity, ContainerData propertyDelegate, int size) {
        super(type, syncId);
