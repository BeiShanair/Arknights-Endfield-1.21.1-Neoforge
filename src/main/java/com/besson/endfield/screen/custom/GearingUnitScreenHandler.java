...
public class GearingUnitScreenHandler extends AbstractContainerMenu {
    ...
    public GearingUnitScreenHandler(int syncId, Inventory playerInventory, BlockEntity blockEntity, ContainerData propertyDelegate) {
        super(ModScreens.GEARING_UNIT_SCREEN.get(), syncId);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, entity.getBlockPos()),
                pPlayer, ModBlocks.GEARING_UNIT.get());
    }
