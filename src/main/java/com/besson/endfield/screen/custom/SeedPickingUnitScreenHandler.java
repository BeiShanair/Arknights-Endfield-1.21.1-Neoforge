...
public class SeedPickingUnitScreenHandler extends AbstractContainerMenu {
    ...
    public SeedPickingUnitScreenHandler(int syncId, Inventory playerInventory, BlockEntity blockEntity, ContainerData propertyDelegate) {
        super(ModScreens.SEED_PICKING_UNIT_SCREEN.get(), syncId);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, entity.getBlockPos()),
                pPlayer, ModBlocks.SEED_PICKING_UNIT.get());
    }
