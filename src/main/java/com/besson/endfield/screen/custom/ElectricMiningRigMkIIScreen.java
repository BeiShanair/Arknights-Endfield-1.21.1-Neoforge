...
public class ElectricMiningRigMkIIScreen extends AbstractContainerScreen<ElectricMiningRigMkIIScreenHandler> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(ArknightsEndField.MOD_ID, "textures/gui/electric_mining_rig_mk_ii.png");
