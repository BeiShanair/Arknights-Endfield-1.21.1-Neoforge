...
public class ElectricMiningRigScreen extends AbstractContainerScreen<ElectricMiningRigScreenHandler> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(ArknightsEndField.MOD_ID, "textures/gui/electric_mining_rig.png");
